import type { ContextJobStatus, ContextPolicyScope, ProviderCallPurpose } from "../db/schema";
...
export type ResolvedContextPolicy = ContextPolicy & { source: ContextPolicySource };
