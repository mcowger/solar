...
export const contextGlobalSettingsInputSchema = contextGlobalSettingsSchema.omit({ version: true });
...
export function parseContextGlobalSettings(value: string | null | undefined): ContextGlobalSettings {
...
export async function setContextGlobalSettings(settings: ContextGlobalSettings): Promise<void> {
